...
<body>
    <div id="wrapper">
    	...
    	<div id="menu">
       	  	<a href="index.php"><img id="home" src="images/home_selected.png" style="left:0;" name="_home" 
        onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('_home','','images/home_selected.png',1)"/></a>
        ...
        <div id="content">
        	<img src="images/homepage_img.png" 
            name="_homeimg" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('_homeimg','','images/homepage_img_hover.png',1)"/>
        </div>
        <div id="footer">
        	<span>
            	<p>
